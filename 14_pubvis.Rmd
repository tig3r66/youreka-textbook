...
<button class="collapsible">Plotting significance (OPTIONAL)</button>
...
<button class="collapsible">Assembly of multiple figures (OPTIONAL)</button>
<div class="collapse_content">  
...
<button class="collapsible">Extras (OPTIONAL)</button>
<div class="collapse_content">  
...
I highly recommend you read through these websites:
  ...
  * The Python Graph Gallery: https://python-graph-gallery.com
    - If you're more comfortable with Python. Includes the visualization and code to create it.
    
![Data visualizations for various data types. Check out https://www.data-to-viz.com/ for an interactive version of this chart!](data/09_ggplot2/data_to_vis.png)
