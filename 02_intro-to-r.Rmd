...
Throughout this text, we will use interactive code blocks provided by the [leanrR](https://rstudio.github.io/learnr/) package. This way, you can run code without having to open RStudio!
