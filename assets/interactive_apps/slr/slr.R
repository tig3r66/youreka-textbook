...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel2(
      ...
      helpText("Code adapted from", a(href="https://github.com/AntoineSoetewey/statistics-202", target="_blank", "Antoine Soetewey's code"), "and", a(href="https://github.com/ShinyEd/intro-stats", "ShinyEd")),
