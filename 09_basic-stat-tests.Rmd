...
Note the variables `country` and `continent` are considered factors (`fct`), which is a catagorical data. We can use `levels()` to obsserve the catagories within a factor column.
...
Let's start by asking the mean life expectancy of the continents in 1952. Let's first summarize our data.
